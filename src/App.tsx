...
import { Plus, Sparkles, CalendarHeart, Moon, Sun, FileSearch } from 'lucide-react'
...
type ActiveTab = 'goals' | 'disclosure'
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-indigo-50/30 dark:from-gray-900 dark:to-gray-950 transition-colors">
      ...
      {/* ボトムタブバー */}
      <nav
        className="fixed bottom-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-800/95 backdrop-blur-md border-t border-gray-200 dark:border-gray-700"
