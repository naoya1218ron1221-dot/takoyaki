  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-indigo-50/30">
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-r from-indigo-500 to-violet-500 text-white rounded-full shadow-lg shadow-indigo-300/50 flex items-center justify-center hover:scale-105 active:scale-95 transition-transform"
        aria-label="新しい野望を追加"
      >
        <Plus size={28} />
      </button>
